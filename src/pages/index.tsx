        ...
        <div className="mx-auto snap-start w-screen h-screen">
          <BackgroundBeamsWithCollision>
            <div className="flex flex-col items-center justify-center w-full h-full z-50">
              ...
              <Button className="mb-20 z-30" onClick={handleScrollToSection}>
                Scroll for more
              </Button>
            </div>
          </BackgroundBeamsWithCollision>
                    ...
                    <div className="flex-1 text-center md:text-left">
                      ...
                      <div className="space-y-4">
                        <p>
                          ...
                          make a lasting impact. I believe in the power of
                          design and development to bridge the gap between users
                          and technology, delivering solutions that are both
